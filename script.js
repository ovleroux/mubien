...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        selector: ".text-link",
        originalId:
          "6266fd2c922d570c5ed9501b|659a611e-c6b0-7cec-f578-d8cb0caac1b0",
        appliesTo: "CLASS",
      },
      targets: [
        {
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".text-link_line",
                  selectorGuids: ["b32a4252-d69b-6dc0-99c7-482e50f269bc"],
                },
                xValue: -101,
                xUnit: "%",
                yUnit: "PX",
    ...
    "a-3": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".arrow",
                  selectorGuids: ["7cdee87b-444d-840d-b50d-feba007816bf"],
                },
                zValue: -180,
                xUnit: "DEG",
                yUnit: "DEG",
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1650914676270,
    },
    "a-4": {
      id: "a-4",
      title: "Page Scrolled Down",
      actionItemGroups: [
        {
          actionItems: [
            {
